...
# bundled music beds + font for the Score + Sting tier (Docker COPY has no inline comments —
# a trailing '# ...' would be parsed as extra source args and break the build)
COPY assets/ ./assets/
